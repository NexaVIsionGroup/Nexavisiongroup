// Store catalog: per-device page content, launch colors, configs and DRAFT
// prices. Prices are placeholders set from the 2026-09 used market plus
// margin for rebuild + warranty — tune before launch. Like-new condition only.
...
export const catalog: Record<string, CatalogEntry> = {
  n15: {
    ...
    configs: [
      { ram: 12, storage: "256GB", price: 1049 },
      { ram: 16, storage: "512GB", price: 1199 },
    ],
    bands: {
  ...
  n13: {
    ...
    configs: [
      { ram: 12, storage: "256GB", price: 799 },
      { ram: 16, storage: "512GB", price: 899 },
    ],
    bands: {
      title: "Built for all three US networks",
  ...
  n12: {
    ...
    configs: [
      { ram: 12, storage: "256GB", price: 649 },
      { ram: 16, storage: "512GB", price: 729 },
    ],
    bands: {
      title: "Built for all three US networks",
  ...
  n11: {
    ...
    configs: [
      { ram: 8, storage: "128GB", price: 449 },
      { ram: 16, storage: "256GB", price: 499 },
    ],
    bands: {
      title: "Built for all three US networks",
  ...
  nfold: {
    ...
    configs: [
      { ram: 16, storage: "512GB", price: 949 },
      { ram: 16, storage: "1TB", price: 1099 },
    ],
    bands: {
      title: "Built for all three US networks",
